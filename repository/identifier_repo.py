...
def create_identifier(transaction:Transaction, org_node, identifier: Identifier):
    ...
    for record in result:
        ...
        # log.info(labels)
        create_relationship(transaction, org_node, identifier_node, identifier.identifier_label, identifier.identifier_rel)
...
def create_relationship(transaction: Transaction, org_node, identifier_node, identifier_label, relationship_label):
    ...
    with open("queries/create_rels.cypher", "r") as f:
        rel_query = f.read()
    rel_result = transaction.run(rel_query, source_label="Organization",
